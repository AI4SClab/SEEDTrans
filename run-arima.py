...
import os
import torch
from experiments.exp_stat import Exp_Main
import random
import numpy as np
...
parser.add_argument('--model_id', type=str,  default='autof1', help='model id')
...
parser.add_argument('--root_path', type=str,
                    default='datasets/pv-data/PVOD_en/', help='root path of the data file')
parser.add_argument('--data_path', type=str,
                    default='涉县台村光伏电站（清洗后）.npy', help='data file')
...
parser.add_argument('--sample', type=float, default=0.001, help='Sampling percentage, the inference time of ARIMA and SARIMA is too long, you might sample 0.01')
# optimization
...
if args.data == 'PV':
    if (args.root_path.__contains__('CPV')):
        feature_dim = 9
    elif (args.root_path.__contains__('DPV')):
        feature_dim = 1
    if (args.root_path.__contains__('PVOD')):
        feature_dim = 14 #7
    if(args.features == 'MS'):
