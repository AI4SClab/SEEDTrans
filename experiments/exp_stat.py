...
from experiments.exp_basic_arima import Exp_Basic
...
class Exp_Main(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            # 这里用的是data_loader的__getitem__方法
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                # 等同于 if self.args.features == 'MS'  则 f_dim = -1    else   f_dim = 0
        ...
        mae, mse, rmse, mape, mspe = metric_Mask(preds, trues)
        corr = []
