...
from layers.MLWT_EncDec_coiflet import Decoder, DecoderLayer, Encoder, EncoderLayer, ConvLayer, my_Layernorm,series_decomp
...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        # 写入日志
        with open("logs/topk_variable_coiflet.txt", "a") as f:
