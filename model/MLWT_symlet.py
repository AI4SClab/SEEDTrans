...
from layers.MLWT_EncDec_symlet import Decoder, DecoderLayer, Encoder, EncoderLayer, ConvLayer, my_Layernorm,series_decomp
...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        _, top_columns = torch.topk(selected_columns, 6)
        ...
        # 写入日志
        with open("logs/topk_variable_symlet.txt", "a") as f:
        ...
        weight1 = weight[:, :, 0:1].mean()
        weight2 = weight[:, :, 1:2].mean()
        weight3 = weight[:, :, 2:3].mean()
        # Apply weight for enc_out
        enc_out = enc_out * weight1 + out_hum * weight2 + out_cld * weight3 #enc_out[32, 144, 16]
        
        #print('enc_out:',enc_out)
        #print('out_hum:',out_hum)
        #print('out_cld:',out_cld)
        print('weight0:1:',weight1)
        print('weight1:2:',weight2)
        print('weight2:3:',weight3)
